process.env.MAISTV_LOCAL_API_ROLE = process.env.MAISTV_LOCAL_API_ROLE || 'assignment-worker';
process.env.LOCAL_API_HTTP_ENABLED = process.env.LOCAL_API_HTTP_ENABLED || 'false';
process.env.ASSIGNMENT_RECOVERY_WORKER_ENABLED = process.env.ASSIGNMENT_RECOVERY_WORKER_ENABLED || 'true';
